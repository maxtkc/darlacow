...
const RELAYS: &'static [&'static str] = &["Cow Up", "Main Motion", "Strobe",  "Monkeys", "Marque Lights",  "Masks",  "Center Lights",  "Disco", "LED Matrix<br>Relay", "Rocket Lights", "BROKEN RELAY", "Launch", "Relay 13", "Relay 14", "Relay 15", "Relay 16"];
